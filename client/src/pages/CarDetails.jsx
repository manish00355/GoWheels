...
const CarDetails = () => {
  ...
  useEffect(()=>{
   const found =  (cars.find(car=> car._id.toString() === id))
   setCar(found)
  },[cars ,id]) 
  ...
  return  car ? (
    ...
    <button onClick={()=> navigate(-1)} className='flex items-center gap-2 mb-6 text-gray-500 cursor-pointer'>
      <img src={assets.arrow_icon} alt="back" className='rotate-180 opacity-65 w-4 h-4'/>
      Back to all Cars
      </button>
       ...
       <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        className='lg:col-span-2'>
          ...
          initial={{opacity:0}}
          animate={{opacity:1}}
          transition={{delay:0.2 , duartion:0.5}}
          ...
          className='space-y-6'>
            ...
            {[
              ...
              key={text} className='flex flex-col items-center big-light p-4 rounded-lg'> 
          ...
          <div>
            ...
            <ul className='grid grid-cols-1 sm:grid-col-2 gap-2'>
              {
                [
        ...
        initial={{opacity:0 , y:30}}
        animate={{opacity:1 , y:0}}
        transition={{delay:0.3 , duartion:0.6}}
